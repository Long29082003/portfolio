...
class OrbitControls extends Controls {
	...
	constructor( object, domElement = null ) {
		...
		this.targetMinClamp = new Vector3(-2.5, 2, -1);
		this.targetMaxClamp = new Vector3(2.8, 5.7, 3.5);
		this.targetDefaultMinClamp = new Vector3().copy(this.targetMinClamp);
		this.targetDefaultMaxClamp = new Vector3().copy(this.targetMaxClamp);
	...
	update( deltaTime = null ) {
		...
		this.target.clamp(this.targetMinClamp, this.targetMaxClamp);
